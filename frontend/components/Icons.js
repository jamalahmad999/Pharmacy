// SVG Icons Component - Branded minimal icons for LifePharmacy
export const Icons = {
  // Navigation Icons
  Menu: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
    </svg>
  ),

  Close: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  // E-commerce Icons
  ShoppingBag: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  Heart: ({ className = "w-6 h-6", filled = false, ...props }) => (
    <svg className={className} {...props} fill={filled ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor">
  ...
  ChevronRight: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
    </svg>
  ),

  ChevronLeft: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  // Pharmacy/Medical Icons
  Pill: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547A1.998 1.998 0 004 17.615V19a2 2 0 002 2h12a2 2 0 002-2v-1.385c0-.698-.282-1.367-.772-1.847z" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 8a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
  ),

  Cross: ({ className = "w-6 h-6", ...props }) => (
  ...
  // Payment Icons
  CreditCard: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  Package: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  Upload: ({ className = "w-6 h-6", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  Logo: ({ className = "w-8 h-8", ...props }) => (
    <svg className={className} {...props} fill="none" viewBox="0 0 32 32">
      <rect width="32" height="32" rx="8" fill="#002579"/>
      <path d="M16 6L8 12v8l8 6 8-6v-8l-8-6z" fill="white"/>
      <circle cx="16" cy="16" r="3" fill="#a92579"/>
    </svg>
  ),
};
